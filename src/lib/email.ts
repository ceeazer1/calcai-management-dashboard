...
export async function sendOrderConfirmationEmail(params: OrderConfirmationParams): Promise<void> {
  ...
  const html = `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><meta name="color-scheme" content="light dark"><style>@media(prefers-color-scheme:dark){.bg{background:#121212!important}.card{background:#1e1e1e!important}.t1{color:#f5f5f5!important}.t2{color:#e0e0e0!important}.t3{color:#a0a0a0!important}.bdr{border-color:#333!important}.box{background:#171717!important;border-color:#333!important}.soc{background:#252525!important;border-color:#333!important}.step{background:#2a2a2a!important;border-color:#404040!important}}@media(max-width:600px){.wrap{width:100%!important}.px{padding-left:16px!important;padding-right:16px!important}}</style></head><body style="margin:0;padding:0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif"><table width="100%" cellpadding="0" cellspacing="0" class="bg" bgcolor="#f5f5f5" style="background:#f5f5f5"><tr><td align="center" class="bg" style="padding:24px 12px"><table width="600" cellpadding="0" cellspacing="0" class="wrap card" bgcolor="#fff" style="max-width:600px;width:100%;background:#fff;border-radius:16px"><tr><td class="card" style="padding:24px"><table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center" style="padding-bottom:16px"><img src="${logo}" width="100" alt="CalcAI" style="display:block;width:100px;height:auto"></td></tr><tr><td align="center" class="t1" style="padding-bottom:20px;border-bottom:1px solid #e5e5e5;color:#1a1a1a;font-size:28px;font-weight:800">Order Confirmed</td></tr></table><table width="100%" cellpadding="0" cellspacing="0" class="box" style="margin:20px 0;background:#fafafa;border:1px solid #e5e5e5;border-radius:12px"><tr><td style="padding:14px"><table width="100%" cellpadding="0" cellspacing="0"><tr><td width="50" align="center"><div style="width:28px;height:28px;background:#22c55e;border-radius:50%;line-height:28px;color:#fff;font-size:14px;font-weight:700">✓</div></td><td><div style="height:3px;background:linear-gradient(90deg,#22c55e,#d4d4d4);border-radius:3px"></div></td><td width="50" align="center"><div class="step" style="width:28px;height:28px;background:#e5e5e5;border:2px solid #d4d4d4;border-radius:50%;display:flex;align-items:center;justify-content:center"><img src="${iGear}" width="14" height="14" style="display:block"></div></td><td><div class="bdr" style="height:3px;background:#d4d4d4;border-radius:3px"></div></td><td width="50" align="center"><div class="step" style="width:28px;height:28px;background:#e5e5e5;border:2px solid #d4d4d4;border-radius:50%;display:flex;align-items:center;justify-content:center"><img src="${iShip}" width="14" height="14" style="display:block"></div></td><td><div class="bdr" style="height:3px;background:#d4d4d4;border-radius:3px"></div></td><td width="50" align="center"><div class="step" style="width:28px;height:28px;background:#e5e5e5;border:2px solid #d4d4d4;border-radius:50%;display:flex;align-items:center;justify-content:center"><img src="${iHome}" width="14" height="14" style="display:block"></div></td></tr><tr><td align="center" style="padding-top:6px;color:#22c55e;font-size:11px;font-weight:700">Placed</td><td></td><td align="center" class="t3" style="padding-top:6px;color:#737373;font-size:11px;font-weight:700">Process</td><td></td><td align="center" class="t3" style="padding-top:6px;color:#737373;font-size:11px;font-weight:700">Shipped</td><td></td><td align="center" class="t3" style="padding-top:6px;color:#737373;font-size:11px;font-weight:700">Delivered</td></tr></table></td></tr></table><p class="t2" style="margin:0 0 12px;color:#1a1a1a;font-size:18px;font-weight:700">Hi ${esc(customerName)},</p><p class="t3" style="margin:0 0 16px;color:#525252;font-size:15px;line-height:1.6">Thank you for your order. We will start processing in 1-2 days.</p><div class="box" style="background:#fafafa;border:1px solid #e5e5e5;border-radius:10px;padding:12px;margin-bottom:16px"><div class="t3" style="color:#737373;font-size:11px;text-transform:uppercase;font-weight:700">Order ID</div><div class="t2" style="margin-top:4px;color:#1a1a1a;font-size:14px;font-family:monospace">${esc(orderId)}</div></div>${pmHtml}<table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:16px"><tr class="bdr" style="border-bottom:1px solid #e5e5e5"><th align="left" class="t3" style="padding:10px 0;color:#737373;font-size:11px;font-weight:700;text-transform:uppercase">Item</th><th align="right" class="t3" style="padding:10px 0;color:#737373;font-size:11px;font-weight:700;text-transform:uppercase">Amount</th></tr>${rows}${shipRow}<tr class="bdr" style="border-top:1px solid #e5e5e5"><td class="t1" style="padding:14px 0;font-weight:800;color:#1a1a1a;font-size:15px">Total</td><td align="right" class="t1" style="padding:14px 0;font-weight:900;color:#1a1a1a;font-size:20px">${fmt(amount, currency)}</td></tr></table><div class="bdr" style="border-top:1px solid #e5e5e5;padding-top:16px;text-align:center"><a href="https://discord.gg/calcai" style="display:inline-block;margin:0 4px;text-decoration:none"><span class="soc" style="display:inline-block;width:32px;height:32px;background:#f5f5f5;border:1px solid #e5e5e5;border-radius:50%;text-align:center;line-height:32px"><img src="${iDiscord}" width="16" height="16" style="vertical-align:middle"></span></a><a href="https://www.tiktok.com/@calc_ai" style="display:inline-block;margin:0 4px;text-decoration:none"><span class="soc" style="display:inline-block;width:32px;height:32px;background:#f5f5f5;border:1px solid #e5e5e5;border-radius:50%;text-align:center;line-height:32px"><img src="${iTiktok}" width="16" height="16" style="vertical-align:middle"></span></a><a href="https://instagram.com/calc.ai" style="display:inline-block;margin:0 4px;text-decoration:none"><span class="soc" style="display:inline-block;width:32px;height:32px;background:#f5f5f5;border:1px solid #e5e5e5;border-radius:50%;text-align:center;line-height:32px"><img src="${iInsta}" width="16" height="16" style="vertical-align:middle"></span></a><p class="t3" style="margin:12px 0 0;color:#a3a3a3;font-size:11px"><a href="https://calcai.cc" style="color:#a3a3a3;text-decoration:none">calcai.cc</a> · ${new Date().getFullYear()} CalcAI</p></div></td></tr></table></td></tr></table></body></html>`;
